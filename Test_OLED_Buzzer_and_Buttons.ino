...
Adafruit_SSD1306 display(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RESET);//khởi tạo đối tượng display cho màn hình OLED với các thông số chiều rộng, chiều cao, thiết bị I2C và chân reset.
...
void setup() {   
  ...
  if(!display.begin(SSD1306_SWITCHCAPVCC, 0x3C)) {  //kiểm tra xem việc khởi tạo màn hình OLED có thành công hay không. Nếu việc khởi tạo thất bại, sẽ in ra thông báo "SSD1306 allocation failed".
    Serial.println(F("SSD1306 allocation failed"));
    for(;;);  //Đoạn code lặp vô hạn để chương trình dừng lại nếu việc khởi tạo màn hình OLED thất bại.
  }
